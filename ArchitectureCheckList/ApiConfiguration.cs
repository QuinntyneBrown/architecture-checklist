...
using System;
using ArchitectureCheckList.App_Start;
using ArchitectureCheckList.Utilities;
using ArchitectureCheckList.Configuration;
using ArchitectureCheckList.Services;
using ArchitectureCheckList.Authentication;
using ArchitectureCheckList.Filters;
...
namespace ArchitectureCheckList
{
    public class ApiConfiguration
    {
        public static void Install(HttpConfiguration config, IAppBuilder app)
        {
            ...
            config
                .EnableSwagger(c => c.SingleApiVersion("v1", "ArchitectureCheckList"))
                .EnableSwaggerUi();
